...
from app.agents.rag_agent_evaluation import (  # noqa: E402
...
def main() -> int:
    ...
    summary = evaluate_rag_agent_cases(cases)

    for line in format_rag_agent_eval_summary(summary):
        print(line)
    for line in format_rag_agent_bad_cases(summary):
        print(line)
